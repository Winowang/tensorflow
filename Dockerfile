...
RUN pip install numpy \
        ...
        keras \
        h5py
#RUN pip install https://download.pytorch.org/whl/cu100/torch-PYTORCHVERSION−(python -c "import wheel.pep425tags as w; print('-'.join(w.get_supported()[0]))").whl \
#        https://download.pytorch.org/whl/cu100/torchvision-TORCHVISIONVERSION−(python -c "import wheel.pep425tags as w; print('-'.join(w.get_supported()[0]))").whl
